...
class EmployeeContactDetailsForm extends sfForm {
    ...
    public function getContactDetailsWidgets() {
        ...
        $minzues = $this->getMinzuList();
        $states = $this->getStatesList();
        $widgets = array();
        
        //creating widgets
        $widgets['country'] = new sfWidgetFormSelect(array('choices' => $countries));
        $widgets['minzu_code'] = new sfWidgetFormSelect(array('choices' => $minzues));
        ...
        $widgets['emp_zipcode2'] = new sfWidgetFormInput();
        ...
        $widgets['weixin_code'] = new sfWidgetFormInput();
        //setting the default values
        
        $widgets['country']->setDefault($this->employee->country);
        $widgets['minzu_code']->setDefault($this->employee->minzu_code);
        ...
        $widgets['emp_zipcode2']->setDefault($this->employee->emp_zipcode2);
        ...
        $widgets['weixin_code']->setDefault($this->employee->weixin_code);
        return $widgets;
    }
    ...
    public function getContactDetailsValidators() {
        $validators = array(
            ...
            'minzu_code' => new sfValidatorString(array('required' => false)),
            ...
            'emp_zipcode2' => new sfValidatorString(array('required' => false)),
            ...
            'weixin_code' => new sfValidatorString(array('required' => false)),
        );
        return $validators;
    }
    ...
    public function getEmployee() {
        ...
        $employee->minzu_code = $this->getValue('minzu_code');
        ...
        $employee->emp_zipcode2 = $this->getValue('emp_zipcode2');
        ...
        $employee->weixin_code = $this->getValue('weixin_code');
        return $employee;
    ...
    public function getCountryService() {
     ...
     /**
     * Returns MinzuService
     * @returns MinzuService
     */
    public function getMinzuService() {

        if (is_null($this->minzuService)) {
            $this->minzuService = new MinzuService();
        }

        return $this->minzuService;
    }
    ...
    private function getMinzuList() {
        $list = array(0 => "-- " . __('Select') . " --");
        $minzues = $this->getMinzuService()->getMinzuList();
