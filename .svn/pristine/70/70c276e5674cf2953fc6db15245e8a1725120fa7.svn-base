        ...
        <div class="inner">
            ...
            <form id="frmEmpJobDetails" method="post" enctype="multipart/form-data" action="<?php echo url_for('pim/viewJobDetails'); ?>">
                <fieldset>
                    ...
                    <ol> <!-- 开始 -->
                        <li><!-- 进院时间 -->
                            <?php echo $form['joined_date']->renderLabel(__('进院时间')); ?>
                            <?php echo $form['joined_date']->render(array("class" => "formDateInput")); ?>
                        </li>
                        
                        <li><!-- 试用期截止日期 new -->
                            <?php echo $form['probation_date']->renderLabel(__('试用期截止日期')); ?>
                            <?php echo $form['probation_date']->render(array("class" => "formDateInput")); ?>
                        </li>
                        <li><!-- 转正时间  new-->
                            <?php echo $form['formal_date']->renderLabel(__('转正时间')); ?>
                            <?php echo $form['formal_date']->render(array("class" => "formDateInput")); ?>
                        </li>
                        <li>
                            <?php echo $form['eeo_category']->renderLabel(__('岗位名称')); ?>
                            <?php echo $form['eeo_category']->render(array("class" => "formSelect")); ?>    
                        </li>
                        <li><!-- 转正时间  new-->
                            <?php echo $form['eeo_cat_describe']->renderLabel(__('岗位描述')); ?>
                            <?php echo $form['eeo_cat_describe']->render(array("class" => "formDateInput")); ?>
                        </li>

                        <li>
                            <?php echo $form['emp_status']->renderLabel(__('编制种类')); ?>
                            <?php echo $form['emp_status']->render(array("class" => "formSelect")); ?>
                        </li>
                        <li>
                            <?php echo $form['job_title']->renderLabel(__('职称等级')); ?>
                            <?php echo $form['job_title']->render(array("class" => "formSelect")); ?>    
                        </li>
                        <li>
                            <?php echo $form['sub_unit']->renderLabel(__('子组')); ?>
                            <?php echo $form['sub_unit']->render(array("class" => "formSelect")); ?>
                        </li>
                        <li>
                            <?php echo $form['emp_cost_center']->renderLabel(__('成本中心')); ?>
                            <?php echo $form['emp_cost_center']->render(array("class" => "formDateInput")); ?>
                        </li>
                        <li>
                            <?php echo $form['location']->renderLabel(__('办公地点')); ?>
    ...
    $(document).ready(function() {
        ...
        $("#frmEmpJobDetails").validate({
            rules: {
                ...
                'job[probation_date]': { required: false, valid_date: function(){ return {format:datepickerDateFormat, required:false, displayFormat:displayDateFormat} } },
                'job[formal_date]': { required: false, valid_date: function(){ return {format:datepickerDateFormat, required:false, displayFormat:displayDateFormat} } },
            ...
            messages: {
                ...
                'job[probation_date]': { valid_date: lang_invalidDate },
                'job[formal_date]': { valid_date: lang_invalidDate },
        ...
        '.calendarBtn', '#job_termination_reason', '#job_eeo_category','#job_eeo_cat_describe','#job_emp_cost_center',
        '#job_joined_date','#job_probation_date','#job_formal_date', '#job_sub_unit', '#job_location',
        ...
        $('#job_joined_date,#job_probation_date,#job_formal_date,#job_contract_start_date,#job_contract_end_date').datepicker('disable');
        ...
        $("#btnSave").click(function() {
            ...
            if ( !readonlyFlag) {  
                ...
                if($("#btnSave").attr('value') == edit) {
                    ...
                    $('#job_joined_date,#job_probation_date,#job_formal_date,#job_contract_start_date,#job_contract_end_date').datepicker('enable');
