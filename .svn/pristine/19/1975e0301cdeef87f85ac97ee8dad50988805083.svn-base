            ...
            <form id="frmEmpContactDetails" method="post" action="<?php echo url_for('pim/contactDetails'); ?>">
                ...
                <fieldset>
                    <ol>
                        ...
                        <li>
                            <?php echo $form['minzu_code']->renderLabel(__("民族")); ?>
                            <?php echo $form['minzu_code']->render(array("class" => "formInputText")); ?>
                        </li>               
                    </ol>
                    <ol>
                        <li>
                    ...
                    <ol>
                        ...
                        <li>
                            <?php echo $form['weixin_code']->renderLabel(__("微信号码")); ?>
                            <?php echo $form['weixin_code']->render(array("class" => "formInputText", "maxlength" => 50)); ?>
                        </li>
                    </ol>
