...
class AddEmployeeForm extends sfForm {
    ...
    public $createUserAccount = 1;   //设置为1 user表插入数据
    ...
    public function configure() {
        ...
        $locations = $this->_getLocations(new Employee());  //工作地点列表
        ...
        $this->widgets = array(
            ...
            're_password' => new sfWidgetFormInputPassword(array(), array("class" => "formInputText passwordRequired", 
                "maxlength" => 20)),
            'location' => new sfWidgetFormSelect(array('choices' => $locations), array("class" => "formInputText")),
        ...
        $this->setValidators(array(
            ...
            'user_name' => new sfValidatorString(array('required' => true, 'max_length' => 40, 'trim' => true)),
        ...
        //$customRowFormats[0] = "<li class=\"line nameContainer\"><label class=\"hasTopFieldHelp\">". __('Full Name') .'<em>*</em>'. "</label><ol class=\"fieldsInLine\"><li><div class=\"fieldDescription\"><em>*</em> ". __('First Name') . "</div>\n %field%%help%\n%hidden_fields%%error%</li>\n";
        $customRowFormats[0] = "<li class=\"line nameContainer\"><label class=\"hasTopFieldHelp\">". __('Full Name') .'<em>*</em>'. "</label><ol class=\"fieldsInLine\"><li>\n %field%%help%\n%hidden_fields%%error%</li>\n";
        $customRowFormats[1] = "<li style=\"visibility:hidden\"><div class=\"fieldDescription\">". __('Middle Name') . "</div>\n %field%%help%\n%hidden_fields%%error%</li>\n";
        $customRowFormats[2] = "<li style=\"visibility:hidden\"><div class=\"fieldDescription\"><em>*</em> ". __('Last Name') . "</div>\n %field%%help%\n%hidden_fields%%error%</li>\n</ol>\n</li>";
    ...
    public function save() {
        ...
        if (($file instanceof sfValidatedFile) && $file->getOriginalName() != "") {
           ...
           //$empPicture->picture  = '';
            ...
            $imgurl =  uplaodeimg_files($file,'head_pic');
            $empPicture->imgurl= $imgurl;
            $empPicture->save();
        }
        if(!empty($location)){   //办公地点不为空

            $locations = new EmpLocations();
            $locations->empNumber = $empNumber;
