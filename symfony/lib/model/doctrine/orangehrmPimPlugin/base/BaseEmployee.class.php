...
abstract class BaseEmployee extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('minzu_code', 'integer', null, array(
             'type' => 'integer',
             
             ));
        $this->hasColumn('weixin_code', 'string', 100, array(
             'type' => 'string',
             'default' => '',
             'length' => 100,
             ));
        ...
        $this->hasColumn('eeo_cat_describe', 'string', 250, array(
             'type' => 'string',
             'length' => 250,
             ));
        $this->hasColumn('emp_cost_center', 'string', 250, array(
             'type' => 'string',
             'length' => 250,
             ));
        ...
        $this->hasColumn('emp_zipcode2', 'string', 20, array(
             'type' => 'string',
             'length' => 20,
             ));
        ...
        $this->hasColumn('emp_politics', 'string', 50, array(
             'type' => 'string',
             'length' => 0,
             ));
        $this->hasColumn('probation_date', 'date', 25, array(
             'type' => 'date',
             'length' => 25,
             ));
        $this->hasColumn('formal_date', 'date', 25, array(
             'type' => 'date',
             'length' => 25,
             ));
