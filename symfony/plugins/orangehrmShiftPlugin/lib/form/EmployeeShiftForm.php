 ...
 */
class EmployeeShiftForm extends BaseForm {
  private $employeeService;
    ...
    public function configure() {
        ...
        $sex = array('1' => __('男'), '2' => __('女'));
        $position = array('1' => __('专家'), '2' => __('医生') ,'3' => __('护士'));
        ...
        $this->widgets = array(
            ...
            'sex' => new sfWidgetFormSelect(array('choices' => $sex), array("class" => "formInputText")),
           ...
           'employeeId' => new sfWidgetFormInputText(array(), array("class" => "formInputText", "maxlength" => 10)),
            ...
            'photofile' => new sfWidgetFormInputFileEditable(array('edit_mode' => false, 'with_delete' => false, 
             ...
             'email' => new sfWidgetFormInputText(array(), array("class" => "formInputText", "maxlength" => 40)),
            'phone' => new sfWidgetFormInputText(array(), array("class" => "formInputText", "maxlength" => 40)),
            'address' => new sfWidgetFormInputText(array(), array("class" => "formInputText", "maxlength" => 40)),
            'position' => new sfWidgetFormSelect(array('choices' => $position), array("class" => "formInputText")),
            'skillLevel' => new sfWidgetFormSelect(array('choices' => $position), array("class" => "formInputText")),
            'wage' => new sfWidgetFormSelect(array('choices' => $position), array("class" => "formInputText")),
            'salary' => new sfWidgetFormSelect(array('choices' => $position), array("class" => "formInputText")),

            'full_time' => new sfWidgetFormInputCheckbox(array('value_attribute_value' => 1), array()),
        ...
        // $this->widgets['full_time']->setDefault($this->getOption('full_time'));

        // $this->widgets['phone']->setDefault($this->getOption('lastName'));
        ...
        $this->setValidators(array(
            ...
            'full_time' => new sfValidatorString(array('required' => false)),
