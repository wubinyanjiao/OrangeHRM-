...
?>                         
<a name="language"></a>
    <div id="setMinSupersor">
        <div class="head">
            <h1 id="headChangeSupersor"><?php echo __('最低监察人数'); ?></h1>
        </div>
        <div class="inner">
            <form id="frmMinSupersor" action="<?php echo url_for('shift/saveDeleteLanguag?empNumber=75' 
                ...
                <fieldset>
                    ...
                    <p>
                        <input type="button" class="" id="btnMinSupervisor" value="<?php echo __("Save"); ?>" />
                        <input type="button" class="reset" id="btnMinSupervisorCancel" value="<?php echo __("Cancel"); ?>" />
                    </p>
                </fieldset>
            </form>
        </div>
...
<div class="miniList" id="tblLanguage">
    ...
    <div class="inner">
            ...
            <form id="frmDelLanguage" action="<?php echo url_for('pim/saveDeleteLanguage?empNumber=' . 
                ...
                <?php echo $listForm ?>
                <p id="actionMinSupersor">
            
                    <input type="button" value="<?php echo __("Add"); ?>" class="" id="addMinSupersor" />&nbsp;
...
<script type="text/javascript">
    ...
    var fileModified = 0;
    var lang_addminsupersor = "<?php echo __('最低监察人数');?>";
...
$(document).ready(function() {
    ...
    $("#addMinSupersor").click(function() {
       
        removeEditLinks();
        clearMessageBar();
        $('div#setMinSupersor label.error').hide();        
        

        //changing the headings
        $("#headChangeSupersor").text(lang_addminsupersor);
        $("div#tblLanguage .chkbox").hide();
        $("#languageCheckAll").hide();

        //hiding action button section
        $("#actionMinSupersor").hide();
    ...
    $("#btnMinSupervisor").click(function() {
        clearMessageBar();

        $("#frmMinSupersor").submit();
    });

    //form validation
    var languageValidator =
        $("#frmMinSupersor").validate({
        rules: {
    ...
    $("#btnMinSupervisorCancel").click(function() {
        clearMessageBar();
