...
<div class="box pimPane">
    ...
    <?php echo include_component('shift', 'pimLeftMenu', array('empNumber'=>$empNumber, 'form' => $form));?>
...
<?php } else { ?>
    ...
    <div class="inner" id="addEmployeeTbl">
        ...
        <form id="frmAddEmp" method="post" action="<?php echo url_for('shift/addShiftEmployee'); ?>" 
