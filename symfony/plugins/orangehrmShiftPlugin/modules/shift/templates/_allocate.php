...
<div id="changeSkill">
    <div class="head">
        <h1 id="headChangeSkill"><?php echo __('分配员工'); ?></h1>
    </div>
                
    <div class="inner">
        <form id="frmSkill" action="<?php echo url_for('shift/saveShiftEmployee?option=save'); ?>" method="post">
            <?php echo $form['_csrf_token']; ?>
     
            <?php echo $form['workShiftId']->render(); ?>
    ...
    <div class="inner">
        ...
        <form id="frmDelSkill" action="<?php echo url_for('pim/saveDeleteSkill?empNumber=' . 
            ...
            <p id="actionSkill">
                ...
                <input type="button" value="<?php echo __("分配员工");?>" class="" id="addSkill" />
...
<script type="text/javascript">
    //<![CDATA[
    var fileModified = 0;
    var lang_addSkill = "<?php echo __('分配员工'); ?>";
    var lang_editSkill = "<?php echo __('分配员工'); ?>";
