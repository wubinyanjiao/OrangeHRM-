 ...
 */
class updateShiftEmployeeAction extends baseShiftAction {
    ...
    public function execute($request) {
        ...
        $this->form = new ShiftDependentForm(array(), $param, true);
        ...
        $this->redirect('shift/addShiftEmployee?empNumber=' . $empNumber);
    }
