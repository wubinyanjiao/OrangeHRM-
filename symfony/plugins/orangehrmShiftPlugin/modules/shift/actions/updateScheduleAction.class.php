 ...
 */
class updateScheduleAction extends baseShiftAction {
    ...
    public function execute($request) {
        ...
        $this->form = new AddScheduleForm(array(), $param, true);
        ...
        $this->redirect("shift/createShift?empNumber=$empNumber&schedule_id=$schedule_id");
    }
