 ...
 *
 */
class addShiftEmployeeAction extends basePimAction {
    ...
    public function execute($request) {
        ...
        if ($allowedToAddEmployee) {
            ...
            $this->setForm(new EmployeeShiftForm(array(), $optionsForForm, true));

            //如果有报错信息，则清除缓存，输出报错信息
            ...
            if ($request->isMethod('post')) {
                ...
                if($photoFile['photofile']['name'] != "" && ($photoFile['photofile']['size'] == 0 || 
                    ...
                    $this->redirect('shift/addShiftEmployee');
                }
