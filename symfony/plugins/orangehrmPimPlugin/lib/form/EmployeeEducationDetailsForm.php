...
class EmployeeEducationDetailsForm  extends BaseForm {
    ...
    private function getPersonalInfoWidgets() {
        $widgets = array(
            ...
            'graduationDate' => new ohrmWidgetDatePicker(array(), array('id' => 'personal_graduationDate')),
        ...
        $widgets['graduationDate']->setAttribute('value', set_datepicker_date_format($this->employee->emp_dri_lice_exp_date));
    ...
    private function getSensitiveInfoWidgets() {
        ...
        $widgets = array('txtEmployeeId' => new sfWidgetFormInputText(),
            ...
            'E_DOB' => new ohrmWidgetDatePicker(array(), array('id' => 'personal_E_DOB')),
            'D_DOB' => new ohrmWidgetDatePicker(array(), array('id' => 'personal_D_DOB')),
        ...
        // $widgets['E_DOB']->setAttribute('value', set_datepicker_date_format($this->employee->emp_birthday));
        // $widgets['D_DOB']->setAttribute('value', set_datepicker_date_format($this->employee->emp_birthday));
    ...
    private function getSensitiveInfoValidators() {
        ...
        $validators = array('txtNICNo' => new sfValidatorString(array('required' => false)),
            ...
            // 'E_DOB' => new ohrmDateValidator(array('date_format' => $inputDatePattern, 'required' => false), array('invalid' => "Date format should be" . $inputDatePattern)));
            // 'D_DOB' => new ohrmDateValidator(array('date_format' => $inputDatePattern, 'required' => false), array('invalid' => "Date format should be" . $inputDatePattern)));
