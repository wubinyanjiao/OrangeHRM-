            ...
            <form id="frmEmpPersonalDetails" method="post" action="<?php echo url_for('pim/viewPersonalDetails'); ?>">
                ...
                <fieldset>
                    ...
                    <ol>
                        ...
                        <li>
                            <label for="personal_txtOtherID"><?php echo __('身份证号'); ?></label>
                            <?php echo $form['txtOtherID']->render(array("maxlength" => 30, "class" => "editable")); ?>
                        </li>
                        <li class="long">
                            <label for="personal_txtPolitics"><?php echo __("政治面貌"); ?></label>
                            <?php echo $form['txtPolitics']->render(array("maxlength" => 30, "class" => "editable")); ?>
                        </li>
                        <li>
                            <label for="personal_txtJoinedDate"><?php echo __('入职时间'); ?></label>
                            <?php echo $form['txtJoinedDate']->render(array("class"=>"calendar editable")); ?>
                        </li>
                        <?php if ($showSSN) : ?>
                        <li class="new">
                    ...
                    <ol>
                        ...
                        <li class="new">
                            <label for="personal_cmbMinzu"><?php echo __("民族"); ?></label>
                            <?php echo $form['cmbMinzu']->render(array("class"=>"editable")); ?>
                        </li>
