...
class LeaveTypeForm extends orangehrmForm {
    ...
    public function configure() {
        ...
        $widgets = array(
            ...
            'leave_is_disable' => new sfWidgetFormInputCheckbox(array('value_attribute_value' => 1)),
        ...
        $validators = array(
            ...
            'leave_is_disable' => new sfValidatorBoolean(),
        ...
        $this->getWidgetSchema()->setLabel('txtLeaveTypeName', __('名称') . ' <em>*</em>');
        // $this->getWidgetSchema()->setLabel('excludeIfNoEntitlement', '<a id="exclude_link" href="#">' . __('Is entitlement situational') . '</a>');
        //$this->getWidgetSchema()->setLabel('excludeIfNoEntitlement', '<a id="exclude_link" href="#">' . __('Is entitlement situational') . '</a>');
        $this->getWidgetSchema()->setLabel('leave_is_disable',  __('禁用') );
    ...
    public function setDefaultValues($leaveTypeId) {
        ...
        if ($leaveTypeObject instanceof LeaveType) {
            ...
            $this->setDefault('leave_is_disable', $leaveTypeObject->getLeaveIsDisable());
    ...
    public function getLeaveTypeObject() {
        ...
        $leaveType->setLeaveIsDisable($this->getValue('leave_is_disable'));
