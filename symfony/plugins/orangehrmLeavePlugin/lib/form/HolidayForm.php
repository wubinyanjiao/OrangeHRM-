...
class HolidayForm extends sfForm {
    ...
    public static function getDaysLengthList() {
        ...
        unset($fullDaysLengthList[4]);
        return $fullDaysLengthList;
    }
    public static function getPeopleGender() {
        $peopleGender = WorkWeek::getPeopleGender();
    ...
    public function setDefaultValues($holidayId) {
        ...
        if ($holidayObject instanceof Holiday) {
            ...
            $this->setDefault('id', $holidayObject->getId());
             $this->setDefault('newdate', $holidayObject->getAddDate());
...
// var_dump(set_datepicker_date_format($holidayObject->getDate()));die;
            $this->setDefault('recurring', $chkRecurring);
            $this->setDefault('length', $holidayObject->getLength());
            $this->setDefault('holiday_gender', $holidayObject->getHolidayGender());
        }
    }
    ...
    protected function getFormWidgets() {
        ...
        $widgets['newdate'] = new sfWidgetFormInputHidden();
        ...
        $widgets['holiday_gender'] = new sfWidgetFormSelect(array(
                    'choices' => self::getPeopleGender(),
                        ), array(
                    'add_empty' => false
                ));
        return $widgets;
    ...
    protected function getFormValidators() {
        ...
        $validators['newdate'] = new sfValidatorString(array('required' => false));
        ...
        $validators['holiday_gender'] = new sfValidatorChoice(array('choices' => array_keys(self::getPeopleGender())));
    ...
    protected function getFormLabels() {
        ...
        $labels['length'] = __('全天/半天');
        $labels['holiday_gender'] = __('限定性别');
    ...
    public function getJavaScripts() {
        ...
        $javaScripts[] = plugin_web_path('orangehrmLeavePlugin', 'js/defineHolidaySuccess.js?v=2');
        $javaScripts[] = plugin_web_path('orangehrmLeavePlugin', 'js/defineHolidaySuccessValidate.js?v=2');
