...
class defineHolidayAction extends baseLeaveAction {
    ...
    public function cshiajaxd(){
        $result['stat'] = 200;
        var_dump('expression');;die;
        $result['message'] ='你输入的截止日期比开始日期小';
