...
abstract class BaseEmployeeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'emp_zipcode2'           => new sfWidgetFormInputText(),
      'weixin_code'           => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
     ...
     // 'middleName'            => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      ...
      'emp_zipcode2'           => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      'weixin_code'           => new sfValidatorString(array('max_length' => 20, 'required' => false)),
